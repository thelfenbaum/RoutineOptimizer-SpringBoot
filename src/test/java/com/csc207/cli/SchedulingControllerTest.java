...
public class SchedulingControllerTest {
    ...
    public void testActivateFixedTaskScheduling(){
        SchedulingController.activateFixedTaskScheduling(week, task1);
    ...
    public void testActivateNonFixedTaskScheduling(){
        SchedulingController.activateNonFixedTaskScheduling(week, task2);
    ...
    public void testActivateProjectScheduling(){
        SchedulingController.activateProjectScheduling(week, tasks);
        assertTrue(week.getDays()[0].getTodayTasks().contains(task2));
    }
